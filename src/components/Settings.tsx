...
export const Settings: React.FC<SettingsProps> = ({ className }) => {
  ...
  const handleLanguageChange = useCallback(
    async (value: string) => {
      ...
      try {
        ...
        setToast({
          message: t("settings.toast.languageSaved"),
          type: "success",
        });
      } catch (error) {
        console.error("Failed to update language preference:", error);
        setToast({
          message: t("settings.toast.languageSaveFailed"),
          type: "error",
        });
      } finally {
  ...
  const saveSettings = async () => {
    try {
      ...
      setToast({ message: t("settings.toast.settingsSaveFailed"), type: "error" });
    } finally {
      setSaving(false);
    }
  };
            ...
            >
              ...
              <TabsContent value="general" className="space-y-6 mt-6">
                <Card className="p-6 space-y-6">
                  <div>
                    <h3 className="text-heading-4 mb-4">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <Label>{t("settings.general.themeLabel")}</Label>
                          <p className="text-caption text-muted-foreground mt-1">
                        ...
                        <div className="flex items-center gap-1 p-1 bg-muted/30 rounded-lg">
                          ...
                          >
                            ...
                            {t("settings.general.themeOptions.gray")}
                          </button>
                          <button
                      ...
                      {theme === "custom" && (
                        <div className="space-y-4 p-4 border rounded-lg bg-muted/20">
                          <h4 className="text-label">
                            {t("settings.general.customColorsTitle")}
                          </h4>
                          ...
                          <p className="text-caption text-muted-foreground">
                            {t("settings.general.customColorsHint")}
                          </p>
                        </div>
                      )}
                      ...
                      <div className="flex items-center justify-between">
                        <div className="space-y-0.5 flex-1">
                          <Label htmlFor="coauthored">
                            {t("settings.general.includeCoAuthor")}
                          </Label>
                          <p className="text-caption text-muted-foreground">
                            {t("settings.general.includeCoAuthorDesc")}
                            requests
                          </p>
                        </div>
                        <Switch
                      ...
                      <div className="flex items-center justify-between">
                        <div className="space-y-0.5 flex-1">
                          ...
                          <p className="text-caption text-muted-foreground">
                            {t("settings.general.verboseOutputDesc")}
                          </p>
                        </div>
                        <Switch
                          id="verbose"
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex-1">
                            <Label htmlFor="cleanup">
                              {t("settings.general.chatRetention")}
                            </Label>
                            <p className="text-caption text-muted-foreground mt-1">
                              {t("settings.general.chatRetentionDesc")}
                              (default: 30 days)
                            </p>
                          </div>
                          <Input
                      ...
                      <div className="flex items-center justify-between">
                        <div className="space-y-1">
                          ...
                          <p className="text-caption text-muted-foreground">
                            {t("settings.general.enableAnalyticsDesc")}
                          </p>
                        </div>
                        <Switch
                          ...
                          onCheckedChange={async (checked) => {
                            if (checked) {
                              ...
                              setToast({
                                message: t("settings.general.analyticsEnabled"),
                                type: "success",
                              });
                            } else {
                              ...
                              setToast({
                                message: t("settings.general.analyticsDisabled"),
                                type: "success",
                              });
                            }
                          }}
                      ...
                      <div className="flex items-center justify-between">
                        <div className="space-y-1">
                          <Label htmlFor="tab-persistence">
                            {t("settings.general.rememberTabs")}
                          </Label>
                          <p className="text-caption text-muted-foreground">
                            {t("settings.general.rememberTabsDesc")}
                          </p>
                        </div>
                        <Switch
                          id="tab-persistence"
                      ...
                      <div className="flex items-center justify-between">
                        <div className="space-y-1">
                          <Label htmlFor="startup-intro">
                            {t("settings.general.showWelcome")}
                          </Label>
                          <p className="text-caption text-muted-foreground">
                            {t("settings.general.showWelcomeDesc")}
                            launches
                          </p>
                        </div>
                        <Switch
                          ...
                          onCheckedChange={async (checked) => {
                            ...
                            try {
                              ...
                              setToast({
                                message: checked
                                  ? t("settings.toast.welcomeIntroEnabled")
                                  : t("settings.toast.welcomeIntroDisabled"),
                                type: "success",
                              });
                            } catch (e) {
                              setToast({
                                message: t("errors.failedToUpdate"),
                                type: "error",
                              });
                            }
                          }}
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <Label className="text-label text-green-500">
                          {t("settings.permissions.allowRules")}
                        </Label>
                        <Button
                          variant="outline"
                          size="sm"
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <Label className="text-label text-red-500">
                          {t("settings.permissions.denyRules")}
                        </Label>
                        <Button
                          variant="outline"
                          size="sm"
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="apiKeyHelper">
                        {t("settings.advanced.apiKeyHelper")}
                      </Label>
                      <Input
                        id="apiKeyHelper"
